...
var createNewTaskElement=function(taskString){
    ...
    label.className='task__label task-name';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className='task__complete';
    editInput.type="text";
    editInput.className="task-name todo-input";
    ...
    deleteButtonImg.alt = 'remove todo item'
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task__complete");
